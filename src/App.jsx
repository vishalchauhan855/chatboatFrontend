    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "☕ Arre bhai! Connection toot gayi. Ek chai pi aur dobara try kar!",
        },
      ]);
    }
        ...
        <div className="chat-panel">
          ...
          <div className="quote-bar">
            ...
            <span className="quote-text">
              Izzat se jiyo, izzat se maro — Kaleen Bhaiya
            </span>
            ...
            {messages.length === 0 && (
              <div className="empty-state">
                ...
                <p className="empty-sub">
                  Kuch bhi pucho... Chandu hazir hai
                </p>
            ...
            {messages.map((msg, i) => (
              ...
              >
                ...
                >
                  ...
                  {msg.role === "user" && (
                    <span className="bubble-label user-label">
                      TU 👤
                    </span>
                  )}
